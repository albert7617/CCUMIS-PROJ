...
import com.example.albert.ccumis_proj.adapters.StuffAdapter;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    fab.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        AlertDialog.Builder builder = new AlertDialog.Builder(com.example.albert.ccumis_proj.EditStuffActivity.this);
        builder.setTitle(R.string.new_stuff_title);
        LayoutInflater inflater = com.example.albert.ccumis_proj.EditStuffActivity.this.getLayoutInflater();
