...
import com.example.albert.ccumis_proj.EditStuffActivity;
import com.example.albert.ccumis_proj.IdenticonGenerator;
import com.example.albert.ccumis_proj.LoginActivity;
import com.example.albert.ccumis_proj.R;
import com.example.albert.ccumis_proj.fragments.AboutFragment;
import com.example.albert.ccumis_proj.fragments.DeleteDocFragment;
...
//            .start();
    ...
    headerView.findViewById(R.id.imageView).setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        Intent intent = new Intent(com.example.albert.ccumis_proj.MainActivity.this, LoginActivity.class);
  ...
  protected void onResume() {
    ...
    if (!pref.getBoolean(getString(R.string.pref_logined), false)) {
      startActivity(new Intent(com.example.albert.ccumis_proj.MainActivity.this, LoginActivity.class));
    }
