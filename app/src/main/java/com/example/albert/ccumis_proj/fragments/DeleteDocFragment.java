...
import com.example.albert.ccumis_proj.tasks.DeleteDocTask;
import com.example.albert.ccumis_proj.tasks.RemoteTask;
import com.example.albert.ccumis_proj.tasks.SelectDeletionTask;
...
public class DeleteDocFragment extends Fragment {
  ...
  private com.example.albert.ccumis_proj.PostEmployment postEmployment;
  ...
  public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
    ...
    final com.example.albert.ccumis_proj.adapters.SelectAdapter selectAdapter = new SelectAdapter(getActivity());
    ...
    final com.example.albert.ccumis_proj.adapters.DepartmentAdapter adapter = new DepartmentAdapter(context, R.layout.support_simple_spinner_dropdown_item);
    spinner.setAdapter(adapter);
    com.example.albert.ccumis_proj.DepartmentViewModel departmentViewModel = ViewModelProviders.of(this).get(DepartmentViewModel.class);
    com.example.albert.ccumis_proj.EmploymentViewModel employmentViewModel = ViewModelProviders.of(this).get(EmploymentViewModel.class);

    employmentViewModel.nukeTable(OPERATION);
    departmentViewModel.getAll(DEPARTMENT_TYPE).observe(this, new Observer<List<com.example.albert.ccumis_proj.data.Department>>() {
      @Override
      public void onChanged(@Nullable List<com.example.albert.ccumis_proj.data.Department> departments) {
    ...
    submit.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        if(start.getTime().after(end.getTime())) {
          ...
          final com.example.albert.ccumis_proj.tasks.SelectDeletionTask task = new SelectDeletionTask((Application) context.getApplicationContext(), postEmployment);
    ...
    employmentViewModel.getEmployments(OPERATION).observe(this, new Observer<List<com.example.albert.ccumis_proj.data.Employment>>() {
      @Override
    ...
    submitCard.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        final com.example.albert.ccumis_proj.tasks.DeleteDocTask task;
  ...
  private com.example.albert.ccumis_proj.tasks.RemoteTask.Callback callback = new com.example.albert.ccumis_proj.tasks.RemoteTask.Callback() {
    @Override
  ...
  private com.example.albert.ccumis_proj.tasks.RemoteTask.Callback deleteCallback = new RemoteTask.Callback() {
    @Override
    public void result(Map<String, String> result) {
      alertDialog.dismiss();
      if(result.get("result").equalsIgnoreCase("400")) {
