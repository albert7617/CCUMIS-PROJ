...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
  ...
  private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
    ...
    ArrayAdapter<String> adapter =
            new ArrayAdapter<>(com.example.albert.ccumis_proj.LoginActivity.this,
    ...
    protected Boolean doInBackground(Void... params) {
      ...
      try {
        Connection.Response response = Jsoup.connect(getString(R.string.url_login))
                ...
                .data("staff_cd", mEmail, "passwd", mPassword, "proj_type", "4")
        ...
        if(document.title().equals("兼任助理、臨時工工作日誌登錄系統")) {
          ...
          editor.putString(getString(R.string.pref_username), mEmail);
